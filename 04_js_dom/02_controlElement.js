...
div1.innerText = "여기는 첫 번째 div 태그이면서 JS에서 <strong>수정</strong>이 있었습니다";

// 해당 요소 내부의 html을 변경
div1.innerHTML = "여기는 첫 번째 div 태그이면서 innerHTML 을 사용해 수정 했습니다";

div1.innerHTML = "여기는 첫 번째 div 태그이면서 <strong>innerHTML 을 사용해 수정</strong> 했습니다";
...
img.setAttribute("src", "../img/beach2.jpg");
...
// 4. 부모, 자식 노드 
const parentsEl = document.querySelector("#flower"); // ul
const childEl = document.querySelector('#flower .pink'); // ul > li.pink

// 자식 노드 접근하기
console.log(parentsEl.children); // ul의 자식 li들 유사배열로 불러옴
console.log(parentsEl.children[2]);
...
// pEl 요소 html에 삽입
// append : 선택도니 요소의 자식 요소로 매개변수 요소가 삽입 됨
// 마지막 자식 요소로 추가됨
// 여러 자식 요소 한 번에 삽입 가능
container.append(pEl);

const pEl2 = document.createElement('p');
pEl2.innerHTML = "새로 만들어진 두 번째 p 태그";
